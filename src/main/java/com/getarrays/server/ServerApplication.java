...
import static com.getarrays.server.enumeration.Status.SERVER_DOWN;
	...
	CommandLineRunner run(ServerRepo serverRepo){
		return args -> {
		   serverRepo.save(new Server(null,"192.168.1.160","Ubuntu Linux","16 GB","Personal Pc","http://localhost:8080/server/image/server1.png", SERVER_UP));
			...
			serverRepo.save(new Server(null,"192.168.1.14","Red Hat Entreprise Linux Linux","64 GB","Mail Server","http://localhost:8080/server/image/server4.png", SERVER_DOWN));
		};
	}
